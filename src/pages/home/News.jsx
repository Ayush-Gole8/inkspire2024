...
const News = () => {
  return (
    <div
      className="py-16 px-6 md:px-12 bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 text-white rounded-3xl shadow-lg"
    >
      <h2 className="text-3xl font-bold mb-6 tracking-wide">News</h2>
      ...
      >
        {news.map((item, index) => (
          <SwiperSlide key={index}>
            <div className="flex flex-col sm:flex-row sm:justify-between items-center gap-12 bg-white text-gray-800 p-6 rounded-2xl shadow-md">
              {/* Content */}
              <div className="py-4">
                <Link to="/">
                ...
                <div className="w-12 h-[4px] bg-gradient-to-r from-purple-500 to-blue-500 mb-5"></div>
